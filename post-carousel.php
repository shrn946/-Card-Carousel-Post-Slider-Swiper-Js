<?php
/**
 * Plugin Name: Swiper Js Card Carousel Post Slider
 * Description: A simple WordPress plugin for Swiper Post Carousel.
 * Version: 1.0
 * Author: Hassan Naqvi
 */


include_once(plugin_dir_path(__FILE__) . 'includes/post-function.php');
...
function swiper_latest_posts_settings_page() {
    ?>
    <div class="wrap">
        <h1>Swiper Latest Posts Settings</h1>
        <p>Welcome to the Swiper Latest Posts plugin settings page. Use the shortcode <code>[swiper_latest_posts]</code> to display all posts.</p>
        ...
        <p>Example usage: <code>[swiper_latest_posts category="people" posts_per_page="2"]</code></p>
